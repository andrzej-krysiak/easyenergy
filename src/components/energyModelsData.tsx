...
export const allModels: EnergyModel[] = [
    {
        ...
        whyThis: 'To doskonały kompromis: korzystasz z rynkowych spadków na co dzień, zachowując "spadochron" ochronny na wypadek nagłego kryzysu giełdowego. Dzięki takiemu podejściu możesz spać spokojnie, wiedząc, że Twoje koszty energii nigdy nie przekroczą bezpiecznego, ustalonego poziomu, niezależnie od sytuacji na rynkach.',
        benefits: [
    ...
    },
    {
        ...
        whyThis: 'Idealne rozwiązanie, jeśli zależy Ci na sztywnym i absolutnie przewidywalnym budżecie bez żadnych niespodzianek na fakturze w ujęciu wieloletnim. Strategia ta pozwala na precyzyjne planowanie kosztów operacyjnych firmy, eliminując całkowicie ryzyko nagłych podwyżek, które mogłyby wpłynąć na Twoją marżę.',
        benefits: [
    ...
    },
    {
        ...
        whyThis: 'Wybierz ten model, jeśli jesteś w stanie zaakceptować ryzyko giełdowe w zamian za możliwość znacznych oszczędności w tzw. "dolinach cenowych". Jest to najbardziej elastyczna forma zakupu, która przy aktywnym zarządzaniu zużyciem pozwala na osiągnięcie najniższych możliwych stawek rynkowych.',
        benefits: [
    ...
    },
    {
        ...
        whyThis: 'Skierowane do firm z aktywną flotą zakupową, pragnących uśrednić cenę, świadomie łapiąc różne okazje rynkowe na przestrzeni kwartałów lub lat. Ten model daje Ci pełną kontrolę decyzyjną oraz unikalną możliwość dywersyfikacji momentów zakupu, co w dłuższej perspektywie optymalizuje budżet.',
        benefits: [
